...
if(this.canResizeColumns!=null)this.canResizeFields=this.canResizeColumns;if(this.canReorderColumns!=null)this.canReorderFields=this.canReorderColumns;if(this.initialCriteria&&this.dataSource){this.criteria=this.initialCriteria;if(this.data!=null&&!(isc.isAn.Array(this.data)&&this.data.length==0)){this.originalData=this.data;this.data=this.getDataSource().applyFilter(this.data,this.initialCriteria)}}
if(this.facets==null)this.deriveFacetValues();this.setFacets();this.setFacetValueGroups();this.setRows();this.setColumns();if(this.enableCharting)this.checkChartConstructor()}
...
,isc.A.recordMarkedAsRemoved=function isc_CubeGrid_recordMarkedAsRemoved(_1){return false}
...
,isc.A.getEditorProperties=function isc_CubeGrid_getEditorProperties(){var _1=this.Super("getEditorProperties",arguments);_1.height=this.cellHeight-2;return _1}
...
if(!this.facetValuesPresent)this.facetValuesPresent={};this.markValuesPresent(_4,_5,true);var _6=this.getFieldProperties(_4,_5);if(!_6)_6={};_6[_2]=_3}
,isc.A.markValuesPresent=function isc_CubeGrid_markValuesPresent(_1,_2,_3){_2=_2||this.getFacetsForPath(_1);var _4=this.logIsInfoEnabled("ignoredRecords");var _5=this.facetValuesPresent,_6,_7,_8=false,_9=null;for(var i=0;i<_2.length;i++){var _11=_2[i];if(!this.inlinedFacet||_11!=this.inlinedFacet.id){if(_1[_11]==null){if(_8&&_7!=null&&!_3){_6[_7]=null}
if(_4){this.logInfo("no value found for facetId: "+_11+" ignoring cellRecord: "+isc.echo(_1),"ignoredRecords")}
break}
var _9=_1[_11];if(_5[_9]==null){_5[_9]={};_8=true}else{_8=false}}else{var _12=this.inlinedFacet.values,_13,_14=false;for(var j=0;j<_12.length;j++){var _9=_12[j].id;if(_1[_9]!==_13){_5[_9]={};_14=true}}
if(!_14&&_8&&_7!=null){if(!_3)_6[_7]=null;if(_4){this.logInfo("no values found for facetId: "+_11+" ignoring cellRecord: "+isc.echo(_1),"ignoredRecords")}}}
_6=_5;_7=_9;_5=_5[_9]}}
...
if(this.dataSource&&this.autoFetchData)this.$90n()}
...
,isc.A.$90n=function isc_CubeGrid__cgFetchData(_1,_2,_3,_4){if(!this.body){this.createChildren()}
var _5=this.body,_6=_5.getDrawArea();var _7=_6[0],_8=_6[1],_9=_6[2],_10=_6[3];if(this.cellIndex==null)this.indexCellRecords();this.queries=[];this.rowGroups=[];var _11=0;for(var _12=_7;_12<=_8;_12++){for(var _13=_9;_13<=_10;_13++){if(this.getCellRecord(_12,_13,true)==null){var _14=this.getCoordFacetValue(_12,true),_15=this.getCoordFacetValue(_13);if(_14==null||_15==null)continue;_11++;if(!_1&&this.body.$250&&this.fetchDelay>0){if(this.fetchTimeout){isc.Timer.clear(this.fetchTimeout);this.fetchTimeout=null}
this.fetchTimeout=this.delayCall("$90n",[true],this.fetchDelay);return}
this.addCellToQuery(_12,_13);if(this.cellIndex[_13]==null)this.cellIndex[_13]=[];this.cellIndex[_13][_12]=Array.LOADING}}}
if(_11==0)return;var _16=this.queries.length;this.combineAllQueries();this.rowGroups.setProperty("$25v",null);var _17=isc.addProperties({},this.lodContext);_17.operation=_17.operationId=this.fetchOperation;_17.$251=_6;_17.$256=_11;_17.$257=this.data.getLength();if(_4!=null){isc.addProperties(_17,_4)}
if(_3!=null){if(_17.clientContext==null)_17.clientContext={};_17.clientContext.fetchCallback=_3}
var _18={target:this,methodName:"$54c"};var _19=this.queries.length;isc.rpc.startQueue();var _20=isc.isAn.emptyObject(this.criteria);for(var i=0;i<_19;i++){var _22=this.queries[i];delete _22.$25y;delete _22.$25z;delete _22.$25x;if(!_20){_22=isc.DataSource.combineCriteria(this.criteria,_22,"and")}
this.getDataSource().fetchData(_22,i<_19-1?{target:this,methodName:"$258"}:_18,_17)}
isc.rpc.sendQueue()}
,isc.A.bindToDataSource=function isc_CubeGrid_bindToDataSource(_1){return _1}
,isc.A.fetchData=function isc_CubeGrid_fetchData(_1,_2,_3){this.criteria=_1;this.setData([]);this.$90n(null,null,_2,_3)}
,isc.A.filterData=function isc_CubeGrid_filterData(_1,_2,_3){this.fetchData(_1,_2,_3)}
...
this.$25a("dataChanged");var _14=_3.clientContext?_3.clientContext.fetchCallback:null;if(_14){this.fireCallback(_14,"dsResponse,data,dsRequest",[_1,_2,_3])}}
...
,isc.A.updateGridComponents=function isc_CubeGrid_updateGridComponents(){if(this.body==null)this.createBodies();if(this.body.parentElement!=this)this.addChild(this.body)}
