...
,isc.A.selectOnMouseUp=function isc_GridRenderer_selectOnMouseUp(_1,_2,_3){if(!this.selectionEnabled())return true;if(_2>=0&&_3>=0){var _4=false;if(this.$89v()){this.$828=true;_4=this.selection.selectOnMouseDown(this,_2,_3)}
this.grid.$67j=true;if(this.selection.selectOnMouseUp(this,_2,_3))_4=true;this.grid.$67j=null;if(_4){this.markForRedraw();if(this.$828){if(this.fireSelectionUpdated)this.fireSelectionUpdated();if(this.grid.getCurrentCheckboxField()!=null){this.grid.updateCheckboxHeaderState()}
this.$828=null}}}}
...
);isc.evalBoundary;isc.B.push(isc.A.noSnapDragOffset=function isc_GridRenderer_noSnapDragOffset(_1){return this.snapToCells}
